...
import fr.unice.polytech.infrastructure.repository.inmemory.GroupOrderRepository;
...
public class GroupOrderHttpServer {
    ...
    static HttpServer server=null;
        static Logger logger = Logger.getLogger(fr.unice.polytech.server.GroupOrderHttpServer.class.getName());
    
        public static void main(String[] args) {
            try {
                startServer(GROUP_ORDER_SERVICE_PORT, new GroupOrderService(new GroupOrderRepository()));
            } catch (IOException e) {
